...
Each app's App Store page was opened and read. Purchases come from the *In-App Purchases* block on that page; 'widget per its description' means the listing's own text mentions a widget, not that we verified one exists.
